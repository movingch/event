...
function doPost(e) {
  ...
  try {
    ...
    return jsonOutput({
      ...
      version: 'v96-master-admin-preserve-widths',
...
function doGet(e) {
  try {
    ...
    if (e && e.parameter && e.parameter.action === 'exportData') {
      return jsonOutput({ ok: true, message: '구글시트 원본 데이터 내보내기 완료', version: 'v96-sheet-source-preserve-widths', data: exportCurrentData_(ss) });
    }
  ...
  return jsonOutput({ ok: true, message: '머내마을영화제 구글시트 연동 웹앱 v96 원본 데이터·열너비 보존 버전이 작동 중입니다.' });
}
